...
ParseUtils.compareLocus = function (newSequence, currentSequence) {
  var newMin = Math.min(newSequence.rangeStart, (0, _min2.default)(newSequence.entries));
  var newMax = Math.max(newSequence.rangeEnd, (0, _max2.default)(newSequence.entries));
  var curMin = Math.min(currentSequence.rangeStart, (0, _min2.default)(currentSequence.entries));
  var curMax = Math.max(currentSequence.rangeEnd, (0, _max2.default)(currentSequence.entries));
  ...
  if ((0, _min2.default)(newUniqueCurrent) > (0, _min2.default)(currentUniqueNew)) {
    return _constants.DELTAEVENT.GT;
  }
