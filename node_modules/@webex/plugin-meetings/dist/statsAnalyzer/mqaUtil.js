...
var getAudioReceiverMqa = function getAudioReceiverMqa(_ref) {
  ...
  var mediaType = 'audio';
  var sendrecvType = 'recv'; // add rtpPacket info inside common as also for call analyzer
...
var getAudioSenderMqa = function getAudioSenderMqa(_ref2) {
  ...
  audioSender.common.roundTripTime = statsResults[mediaType][sendrecvType].roundTripTime * 1000 || 0; // Calculate the outgoing bitrate
...
var getVideoReceiverMqa = function getVideoReceiverMqa(_ref3) {
  ...
  var sendrecvType = 'recv'; // collect the packets received for the last min
  ...
  videoReceiver.streams[0].common.receivedBitrate = totalBytesReceivedInaMin ? totalBytesReceivedInaMin * 8 / 60 : 0; // From tracks //TODO: calculate a proper one
