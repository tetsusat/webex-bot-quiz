...
var Meetings = /*#__PURE__*/function (_WebexPlugin) {
  ...
  function Meetings() {
    ...
    _this.meetingInfo = new _meetingInfo.default({}, {
      parent: _this.webex
    });
    /**
    ...
    _util.default.triggerH264Codec();
  ...
  (0, _createClass2.default)(Meetings, [{
    ...
    value: function listenForEvents() {
      ...
      this.webex.internal.mercury.on(_constants.ROAP.ROAP_MERCURY, function (envelope) {
        _util.default.handleRoapMercury(envelope, _this3.meetingCollection);
      });
    ...
    value: function register() {
      ...
      return _promise.default.all([this.startReachability(), this.webex.internal.device.register().then(function () {
    ...
    value: function create(destination) {
      ...
      .catch(function (error) {
        ...
        var targetDest = options.wasHydraPerson ? options.destination : destination; // check for the conversation URL then sip Url
          ...
          return _this8.createMeeting(targetDest, type).then(function (createdMeeting) {
            ...
            if (createdMeeting && createdMeeting.on) {
              ...
              createdMeeting.on(_constants.EVENTS.DESTROY_MEETING, function (payload) {
                if (_this8.config.autoUploadLogs) {
                  var _meeting$locusInfo, _meeting$locusInfo$fu;

                  _this8.uploadLogs({
                    callStart: (_meeting$locusInfo = meeting.locusInfo) === null || _meeting$locusInfo === void 0 ? void 0 : (_meeting$locusInfo$fu = _meeting$locusInfo.fullState) === null || _meeting$locusInfo$fu === void 0 ? void 0 : _meeting$locusInfo$fu.lastActive,
                    correlationId: meeting.correlationId,
                    feedbackId: meeting.correlationId,
                    locusId: meeting.locusId,
                    meetingId: meeting.id
                  }).then(function () {
                    return _this8.destroy(createdMeeting, payload.reason);
                  });
                } else {
              ...
              createdMeeting.on(_constants.EVENTS.REQUEST_UPLOAD_LOGS, function (meetingInstance) {
                if (_this8.config.autoUploadLogs) {
                  var _meetingInstance$locu, _meetingInstance$locu2;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 3;
                _context.next = 6;
                return this.meetingInfo.fetchMeetingInfo(_util.default.extractDestination(destination, type), type);
              ...
              case 17:
                ...
                if (type !== _constants._LOCUS_ID_) {
                  ...
                  meetingAddedType = _util.default.getMeetingAddedType(type); // We typically shouldn't need to trigger both and event and return a promise.
    ...
    value: function syncMeetings() {
      ...
      return this.request.getActiveMeetings().then(function (locusArray) {
        ...
        if ((0, _keys.default)(_this9.meetingCollection.getAll()).length > 0) {
          // Some time the mercury event is missed after mercury reconnect
          // if sync returns no locus then clear all the meetings
          (0, _forEach2.default)(_this9.meetingCollection.getAll(), function (meeting) {
            if (!activeLocusUrl.includes(meeting.locusUrl)) {
              if (_this9.config.autoUploadLogs) {
                var _meeting$locusInfo2, _meeting$locusInfo2$f;

                _this9.uploadLogs({
                  callStart: (_meeting$locusInfo2 = meeting.locusInfo) === null || _meeting$locusInfo2 === void 0 ? void 0 : (_meeting$locusInfo2$f = _meeting$locusInfo2.fullState) === null || _meeting$locusInfo2$f === void 0 ? void 0 : _meeting$locusInfo2$f.lastActive,
                  correlationId: meeting.correlationId,
                  feedbackId: meeting.correlationId,
                  locusId: meeting.locusId,
                  meetingId: meeting.id
                }).then(function () {
                  return _this9.destroy(meeting, _constants.MEETING_REMOVED_REASON.NO_MEETINGS_TO_SYNC);
                });
              } else {
