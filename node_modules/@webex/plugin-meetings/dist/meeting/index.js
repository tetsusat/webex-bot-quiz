...
var _audio = _interopRequireDefault(require("../meeting/audio"));

var _video = _interopRequireDefault(require("../meeting/video"));
  ...
  function Meeting(attrs, options) {
    ...
    (0, _defineProperty3.default)((0, _assertThisInitialized2.default)(_this), "getMediaStreams", function (mediaDirection) {
      ...
      if (mediaDirection && (mediaDirection.sendAudio || mediaDirection.sendVideo || mediaDirection.sendShare)) {
        if (mediaDirection && mediaDirection.sendAudio && mediaDirection.sendVideo && mediaDirection.sendShare && _bowser.default.safari) {
  ...
  (0, _createClass2.default)(Meeting, [{
    ...
    value: function setUpLocusMediaSharesListener() {
      ...
      this.locusInfo.on(_constants.EVENTS.LOCUS_INFO_UPDATE_MEDIA_SHARES, function (payload) {
        var _payload$current = payload.current,
            ...
            disposition = _payload$current.disposition; // Check if screenshare is being taken over by a remote
        ...
        if (_this9.isSharing && _this9.selfId !== contentId && disposition !== _constants.FLOOR_ACTION.RELEASED) {
          _this9.updateShare({
            ...
            _this9.isSharing = false; // Trigger remote share start event
    ...
    value: function setLocalTracks(localStream) {
      if (localStream) {
        ...
        if (audioTrack) {
          ...
          _loggerProxy.default.logger.log('Meeting:index#setLocalTracks --> Audio settings.', (0, _stringify.default)(this.mediaProperties.mediaSettings.audio));
        ...
        if (videoTrack) {
          ...
          _loggerProxy.default.logger.log('Meeting:index#setLocalTracks --> Video settings.', (0, _stringify.default)(this.mediaProperties.mediaSettings.video));
        }
    ...
    value: function setLocalShareTrack(localShare) {
      ...
      if (localShare) {
        ...
        if (contentTracks) {
          ...
          _loggerProxy.default.logger.log('Meeting:index#setLocalTracks --> Screen settings.', (0, _stringify.default)(this.mediaProperties.mediaSettings.screen));
        }
    ...
    value: function setReconnectListener() {
      ...
      this.webex.internal.mercury.on(_constants.ONLINE, function () {
        _loggerProxy.default.logger.log('Meeting:index#setReconnectListener --> Web socket online');
      });
    }
    /**
    ...
    value: function muteAudio() {
      ...
      return logRequest(this.audio.toggle({
        ...
        _metrics.default.sendOperationalMetric(_constants.METRICS_OPERATIONAL_MEASURES.MUTE_AUDIO_FAILURE, {
          ...
          locus_id: _this22.locusUrl.split('/').pop(),
          reason: error.message,
          stack: error.stack
        });
    ...
    value: function unmuteAudio() {
      ...
      return logRequest(this.mute(this.members.selfId, false) // Next, start sending the local audio media
      .then(function () {
    ...
    value: function reconnect(options) {
      ...
      _loggerProxy.default.logger.log('Meeting:index#reconnect --> attempting to reconnect');

      if (!this.reconnectionManager || !this.reconnectionManager.reconnect) {
        throw new _parameter.default('Cannot reconnect, ReconnectionManager must first be defined.');
      }
    ...
    value: function moveTo(resourceId) {
      ...
      _metrics.default.mediaCapabilities({
        meeting: this,
        data: {
          mediaCapabilities: {
            rx: {
      ...
      return _util.default.joinMeetingOptions(this, {
        ...
        return _this29.updateMedia({
          ...
          return _promise.default.resolve(_this29);
        });
      }).catch(function (error) {
    ...
    value: function moveFrom(resourceId) {
      ...
      return _util.default.joinMeetingOptions(this).then(function (join) {
        return _this30.getMediaStreams({
          ...
          return _util.default.leaveMeeting(_this30, {
            resourceId: resourceId,
    ...
    value: function addMedia() {
      ...
      if (_util.default.isGuestUnjoined(this.locusInfo) && !this.wirelessShare) {
        return _promise.default.reject(new _media2.default("To add media, the ".concat(this.guest ? 'guest' : '', " user must be ").concat(this.guest ? 'admitted. Wait to be admitted' : 'joined to the meeting', " to call addMedia")));
      }
      ...
      return _util.default.validateOptions(options).then(function () {
        if (!_this31.mediaProperties.peerConnection) {
          _this31.mediaProperties.setMediaPeerConnection(_util2.default.createPeerConnection());
        }

        _this31.setReconnectListener();

        _peerConnectionManager.default.setPeerConnectionEvents(_this31);

        return _this31.preMedia(localStream, localShare, mediaSettings);
      }).then(function () {
        return _media.default.attachMedia(_this31.mediaProperties, {
          meetingId: _this31.id,
          remoteQualityLevel: _this31.mediaProperties.remoteQualityLevel,
          enableRtx: _this31.config.enableRtx
        }).then(function (peerConnection) {
          _loggerProxy.default.logger.info("".concat(LOG_HEADER, " PeerConnection Received from attachMedia ").concat(peerConnection));

          _this31.setRemoteStream(peerConnection);

          _util.default.startInternalStats(_this31);
          ...
          if (_this31.config.stats.enableStatsAnalyzer) {
            _this31.statsAnalyzer = new _statsAnalyzer.default(_this31.config.stats);
            ...
            _this31.statsAnalyzer.on(_constants.EVENT_TRIGGERS.MEDIA_QUALITY, function (res) {
              ...
              _metrics.default.postEvent({
                ...
                meetingId: _this31.correlationId,
                data: {
                  intervalData: res
                }
              });
          ...
          _loggerProxy.default.logger.error("".concat(LOG_HEADER, " Error joining the call on roap initialization, "), error);
    ...
    value: function updateMedia() {
      ...
      return _util.default.validateOptions(options).then(function () {
        ...
        return _media.default.updateMedia(_this32.mediaProperties, {
    ...
    value: function updateAudio(options) {
      ...
      return _util.default.validateOptions({
        ...
        _this33.audio = _this33.audio || _audio.default.create(_this33.mediaProperties.mediaDirection, _this33);
      });
    }
    /**
    ...
    value: function updateVideo(options) {
      ...
      return _util.default.validateOptions({
        ...
        _this34.video = _this34.video || _video.default.create(_this34.mediaProperties.mediaDirection, _this34);
      });
    }
    /**
    ...
    value: function preMedia(localStream, localShare, mediaSettings) {
      ...
      this.audio = this.audio || _audio.default.create(this.mediaProperties.mediaDirection, this);
      this.video = this.video || _video.default.create(this.mediaProperties.mediaDirection, this); // Validation is already done in addMedia so no need to check if the lenght is greater then 0
    ...
    value: function leave() {
      ...
      return _util.default.leaveMeeting(this, options).then(function (leave) {
        _this38.meetingFiniteStateMachine.leave(); // upload logs on leave irrespective of meeting delete


        _triggerProxy.default.trigger(_this38, {
          file: 'meeting/index',
          function: 'leave'
        }, _constants.EVENTS.REQUEST_UPLOAD_LOGS, _this38); // TODO: more testing before we remove this code, we are not sure the scenarios for destroy here
    ...
    value: function changeVideoLayout(layoutType) {
      ...
      var _this$mediaProperties3 = this.mediaProperties,
          ...
          remoteVideoTrack = _this$mediaProperties3.remoteVideoTrack; // TODO: We need a real time value for Audio, Video and Share send indicator
    ...
    value: function setLocalVideoQuality(level) {
      ...
      if (!_constants.VIDEO_RESOLUTIONS[level]) {
        var errorMessage = "Meeting:index#setLocalVideoQuality --> ".concat(level, " not defined");

        _loggerProxy.default.logger.error(errorMessage);

        return _promise.default.reject(new Error(errorMessage));
      }
    ...
    value: function setRemoteQualityLevel(level) {
      ...
      if (!_constants.QUALITY_LEVELS[level]) {
        var errorMessage = "Meeting:index#setRemoteQualityLevel --> ".concat(level, " not defined");
      ...
      if (!this.mediaProperties.mediaDirection.receiveAudio && !this.mediaProperties.mediaDirection.receiveVideo) {
        ...
        return _promise.default.reject(new Error(_errorMessage3));
      } // If level is already the same, don't do anything
    ...
    value: function setMeetingQuality(level) {
      ...
      if (!_constants.QUALITY_LEVELS[level]) {
        var errorMessage = "Meeting:index#setMeetingQuality --> ".concat(level, " not defined");
      ...
      return (sendVideo ? this.setLocalVideoQuality(level) : _promise.default.resolve()).then(function () {
        return receiveAudio || receiveVideo ? _this43.setRemoteQualityLevel(level) : _promise.default.resolve();
      }).catch(function (error) {
