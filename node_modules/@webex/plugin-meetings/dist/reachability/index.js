  ...
  (0, _createClass2.default)(Reachability, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!((_window = window) === null || _window === void 0 ? void 0 : (_window$localStorage = _window.localStorage) === null || _window$localStorage === void 0 ? void 0 : _window$localStorage.removeItem)) {
                  _context.next = 5;
                  break;
                }
    ...
    value: function createPeerConnection(cluster) {
      ...
      try {
        ...
        _loggerProxy.default.logger.error("Reachability:index#getLocalSDPForClusters --> Error creating peerConnection: ".concat(peerConnectionError));
              ...
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  return _context2.abrupt("return", _this.iceGatheringState(peerConnection).catch(function (iceGatheringStateError) {
                    _loggerProxy.default.logger.error("Reachability:index#getLocalSDPForClusters --> Error in getLocalSDP : ".concat(iceGatheringStateError));
                  }));
    ...
    value: function logUnreachableClusters() {
      ...
      list.forEach(function (cluster) {
        _loggerProxy.default.logger.error("Reachability:index#getLocalSDPForClusters --> No ice candidate for ".concat(cluster, "."));
      });
    }
    /**
