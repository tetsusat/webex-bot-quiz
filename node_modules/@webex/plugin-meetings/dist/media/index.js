...
Media.getDisplayMedia = function (options) {
  ...
  if (_bowser.default.name.toLowerCase() === 'firefox') {
    var mediaConfig = {
  ...
  if (options.sendAudio && _bowser.default.name.toLowerCase() !== 'safari') {
...
Media.getMedia = function (audio, video, config) {
  ...
  var mediaConfig = {
    ...
    video: video ? _bowser.default.firefox && video.width && video.width.max === 320 ? {
